    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (transactionAttributes && transactionAttributes.currentFlowBlock) {
            ...
            if (smaEvent.InvocationEventType === EventTypes_1.EventTypes.ACTION_SUCCESSFUL || smaEvent.InvocationEventType === EventTypes_1.EventTypes.CALL_ANSWERED) {
                ...
                return yield processFlowActionDisconnectParticipant(smaEvent, transactionAttributes.currentFlowBlock);
            }
        }
        else {
...
function storeSystemAttributs(smaEvent, amazonConnectFlowID, amazonConnectInstanceID) {
    return __awaiter(this, void 0, void 0, function* () {
        const legA = getLegACallDetails(smaEvent);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (action.Type) {
            ...
            case AmazonConnectActionTypes_1.AmazonConnectActions.UpdateContactTextToSpeechVoice:
                return yield processFlowActionUpdateContactTextToSpeechVoice(smaEvent, action, actions, amazonConnectInstanceID, bucketName);
            case AmazonConnectActionTypes_1.AmazonConnectActions.InvokeLambdaFunction:
                return yield processFlowActionInvokeLambdaFunction(smaEvent, action, actions, amazonConnectInstanceID, bucketName);
            case AmazonConnectActionTypes_1.AmazonConnectActions.UpdateContactAttributes:
                return yield processFlowActionUpdateContactAttributes(smaEvent, action, actions, amazonConnectInstanceID, bucketName);
            case AmazonConnectActionTypes_1.AmazonConnectActions.Compare:
                return yield processFlowActionCompareContactAttributes(smaEvent, action, actions, amazonConnectInstanceID, bucketName);
            default:
                null;
        }
    });
...
function processFlowActionFailed(smaEvent, actionObj, contactFlow, amazonConnectInstanceID, bucketName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (smaEvent != null && smaEvent.ActionData.ErrorType.includes(ErrorTypes_1.ErrorTypes.InputTimeLimitExceeded)) {
            nextAction = yield getNextActionForError(currentAction, contactFlow.Actions, ErrorTypes_1.ErrorTypes.InputTimeLimitExceeded);
            ...
            nextAction = yield getNextActionForError(currentAction, contactFlow, ErrorTypes_1.ErrorTypes.NoMatchingCondition);
            smaAction = yield (yield processFlowAction(smaEvent, nextAction, contactFlow.Actions, amazonConnectInstanceID, bucketName)).Actions[0];
        }
        else if (smaEvent != null && smaEvent.ActionData.ErrorType.includes(ErrorTypes_1.ErrorTypes.ConnectionTimeLimitExceeded)) {
            nextAction = yield getNextActionForError(currentAction, contactFlow, ErrorTypes_1.ErrorTypes.ConnectionTimeLimitExceeded);
            smaAction = yield (yield processFlowAction(smaEvent, nextAction, contactFlow.Actions, amazonConnectInstanceID, bucketName)).Actions[0];
        }
        else if (smaEvent != null && smaEvent.ActionData.ErrorType.includes(ErrorTypes_1.ErrorTypes.CallFailed)) {
            nextAction = yield getNextActionForError(currentAction, contactFlow, ErrorTypes_1.ErrorTypes.CallFailed);
            smaAction = yield (yield processFlowAction(smaEvent, nextAction, contactFlow.Actions, amazonConnectInstanceID, bucketName)).Actions[0];
        }
        else if (smaEvent != null && smaEvent.ActionData.ErrorType.includes(ErrorTypes_1.ErrorTypes.InvalidPhoneNumber)) {
            nextAction = yield getNextActionForError(currentAction, contactFlow, ErrorTypes_1.ErrorTypes.InvalidPhoneNumber);
            smaAction = yield (yield processFlowAction(smaEvent, nextAction, contactFlow.Actions, amazonConnectInstanceID, bucketName)).Actions[0];
        }
        else {
            let count;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (smaEvent != null && condition.length > 0) {
            ...
            if (nextAction_id === null && nextAction_id === "undefined" && !nextAction_id && actionObj.Parameters && actionObj.Parameters.StoreInput == "false") {
                nextAction = yield getNextActionForError(currentAction, contactFlow.Actions, ErrorTypes_1.ErrorTypes.NoMatchingCondition);
                ...
                nextAction = yield getNextActionForError(currentAction, contactFlow.Actions, ErrorTypes_1.ErrorTypes.NoMatchingError);
                console.log("Conditions are not matching with Recieved Digits ");
            }
            console.log("Next Action identifier:" + nextAction_id);
            smaAction = yield (yield processFlowAction(smaEvent, nextAction, contactFlow.Actions, amazonConnectInstanceID, bucketName)).Actions[0];
...
/**
  ...
  */
function processFlowActionInvokeLambdaFunction(smaEvent, action, actions, amazonConnectInstanceID, bucketName) {
    return __awaiter(this, void 0, void 0, function* () {
        let smaAction;
        ...
        let inputForInvoking = yield inputForInvokingLambda(action);
        const params = { FunctionName: LambdaARN,
            InvocationType: 'RequestResponse',
            Payload: JSON.stringify(inputForInvoking)
        };
        let result = yield lambda.invoke(params).promise();
        if (result === null && result === "undefined" && !result) {
            let nextAction = yield getNextActionForError(action, actions, ErrorTypes_1.ErrorTypes.NoMatchingError);
            return yield processFlowAction(smaEvent, nextAction, actions, amazonConnectInstanceID, bucketName);
        }
...
function inputForInvokingLambda(action) {
    return __awaiter(this, void 0, void 0, function* () {
...
/**
  ...
  * @returns The Next SMA Action to perform
  */
function processFlowActionUpdateContactAttributes(smaEvent, action, actions, amazonConnectInstanceID, bucketName) {
    return __awaiter(this, void 0, void 0, function* () {
...
function processFlowActionCompareContactAttributes(smaEvent, action, actions, amazonConnectInstanceID, bucketName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (nextAction === null || !nextAction || nextAction === "undefined") {
                ...
                let nextAction = yield getNextActionForError(action, actions, ErrorTypes_1.ErrorTypes.NoMatchingCondition);
                return yield processFlowAction(smaEvent, nextAction, actions, amazonConnectInstanceID, bucketName);
            }
        }
        catch (e) {
...
/**
  ...
  * @returns SMA Action
  */
function processFlowActionUpdateContactTextToSpeechVoice(smaEvent, action, actions, amazonConnectInstanceID, bucketName) {
    return __awaiter(this, void 0, void 0, function* () {
