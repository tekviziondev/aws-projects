...
class GetParticipantInput {
    async processFlowActionGetParticipantInput(smaEvent, action, SpeechAttributeMap, contextAttributs, ActualFlowARN, ContactFlowARNMap, defaultLogger, puaseAction) {
        ...
        if (action.Parameters.Media != null) {
            ...
            return await playAudioGetDigits.processPlayAudioAndGetDigits(smaEvent, action, defaultLogger, puaseAction);
        }
        ...
        let smaAction = {
            ...
            Parameters: {
                "CallId": legA.CallId,
                "SpeechParameters": (0, speech_parameter_1.getSpeechParameters)(smaEvent, action, contextAttributs, SpeechAttributeMap, defaultLogger),
                "FailureSpeechParameters": (0, speech_parameter_1.getSpeechParameters)(smaEvent, action, contextAttributs, SpeechAttributeMap, defaultLogger),
                "MinNumberOfDigits": 1,
                "Repeat": 3
            }
        };
