...
async function terminatingFlowAction(smaEvent, action, SpeechAttributeMap, contextAttributs, ActualFlowARN, ContactFlowARNMap, defaultLogger, puaseAction, actionType) {
    let text;
    let type;
    let x;
