...
class DisconnectParticipant {
    async processFlowActionDisconnectParticipant(smaEvent, action, SpeechAttributeMap, contextAttributs, ActualFlowARN, ContactFlowARNMap, defaultLogger, puaseAction) {
        let callId;
        let smaAction1;
