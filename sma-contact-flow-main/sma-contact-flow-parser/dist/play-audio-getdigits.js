...
class PlayAudioAndGetDigits {
    async processPlayAudioAndGetDigits(smaEvent, action, defaultLogger, puaseAction) {
        ...
        let smaAction = {
            ...
            Parameters: {
                ...
                "FailureAudioSource": (0, audio_parameters_1.getAudioParameters)(smaEvent, action, defaultLogger),
                "MinNumberOfDigits": 5,
                "Repeat": 3
            }
        };
