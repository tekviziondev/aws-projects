...
class CompareAttribute {
    async processFlowActionCompareContactAttributes(smaEvent, action, actions, amazonConnectInstanceID, bucketName, defaultLogger, contextAttributes) {
        ...
        try {
            ...
            if (nextAction === null || !nextAction) {
                ...
                let nextAction = await (0, next_action_error_1.getNextActionForError)(action, actions, ErrorTypes_1.ErrorTypes.NoMatchingCondition, smaEvent, defaultLogger);
