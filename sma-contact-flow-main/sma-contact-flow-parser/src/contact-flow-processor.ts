...
async function processFlowActionInvokeFlowModule(smaEvent: any, action: any,actions:any, amazonConnectInstanceID: string, bucketName:string){
...
function count(str, find) {
 ...
 async function terminatingFlowAction(smaEvent:any, actionType:any){
    let text:string;
    let type:string;
    let x:Number;
    let voiceId=ConstData.voiceId
