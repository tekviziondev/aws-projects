...
<br>7. After that you can able to use the created Lex Bot and External Lambda Function in the Contact Flow blocks of "Invoke AWS Lambda function" and "Amazon Lex" in "Getparticipant Input"
